...
public final class PhoneStatusBarTransitions extends BarTransitions {
    ...
    private View mLeftSide, mStatusIcons, mSignalCluster, mBattery, mClock, mCenterClock, mNetworkTraffic, mMinitBattery, mSixLogoRight, mSixLogoLeft;
    ...
    public void init() {
        ...
        mSixLogoRight = mView.findViewById(R.id.six_logo);
        mSixLogoLeft = mView.findViewById(R.id.left_six_logo);
    ...
    private void applyMode(int mode, boolean animate) {
        ...
        if (animate) {
            ...
            anims.playTogether(
                    ...
                    animateTransitionTo(mSixLogoRight, newAlphaBC),
                    animateTransitionTo(mSixLogoLeft, newAlphaBC)
                    );
            if (isLightsOut(mode)) {
            ...
            mSixLogoRight.setAlpha(newAlphaBC);
            mSixLogoLeft.setAlpha(newAlphaBC);
        }
    }
}
